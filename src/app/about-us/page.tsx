...
export default function page() {
  return (
    <main className='w-10/12 mx-auto container  leading-7 '>
      ...
      <p className="text-[18px]">
        ...
        If you log in using your mobile number or email ids we use your first name and last name mobile number and/or e-mail address to identify you as a user and provide access to our Platform.
