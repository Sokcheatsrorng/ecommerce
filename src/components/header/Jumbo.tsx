            ...
            <section className="">
                <div className=" px-4 mx-auto max-w-screen-xl ">
                    <div className="bg-green-100 flex flex-row-reverse rounded-lg p-8 md:p-12 mb-8">
                        <div className='w-1/3'>
                            <Image width={100} height={100} src={'/assets/numKhmer.png'} alt='Num-Khmer' />
                        </div>
                        <div className=' grid-cols-2 justify-center  items-center'>
                            ...
                            <figure className="w-10/12 mt-10 mx-auto " >
                                ...
                                <blockquote>
                                    <p className=" text-2xl italic font-medium text-orange-950 opacity-1">&rdquo Bring the taste of Khmer desserts to the world.</p>
                                    <p className=" ml-3 text-2xl italic font-mediumtext-orange-950 opacity-1">នាំយក​រសជាតិដើមរបស់ខ្មែរទៅកាន់ពិភពលោក &rdquo</p>
                                </blockquote>
                    ...
                    <div className="w-9/12 mx-auto grid md:grid-cols-2 gap-12 mb-10">
                        <div className="  bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg  ">
                            ...
                            <Image width={100} height={100} src={'/assets/location.jpg'} alt='Location of Our Shop'/>
